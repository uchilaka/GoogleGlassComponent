...
<h1>REQUIREMENTS</h1>
<ul>
  <li>Working knowledge of coding in CakePHP </li>
...
<blockquote>
  ...
  <blockquote>
    ...
    <p>$config: This is an associative array with the following parameters: </p>
    <blockquote>
  ...
  <p>inserts a pre-built timeline item into the user's glass timeline. The <em>$timeline_item</em> variable must be of type <em>Google_TimelineItem</em>. See the documentation for the Glass Mirror API for details: https://developers.google.com/glass/v1/reference/timeline</p>
  <ul>
